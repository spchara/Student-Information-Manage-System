# Generated by Django 5.1.3 on 2024-11-17 17:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'db_table': 'course',
                'constraints': [
                    models.CheckConstraint(check=models.Q(Ccredit__range=(0, 10)), name='course_chk_1'),
                    models.CheckConstraint(check=(models.Q(Cpno__isnull=True) | ~models.Q(Cpno=models.F('Cno'))), name='course_chk_2'),
                    models.CheckConstraint(check=models.Q(Chours__range=(1, 99)), name='course_chk_3')
                ],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='manageSystem.course')),
                ('student', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='manageSystem.student')),
            ],
            options={
                'db_table': 'sc',
                'constraints': [
